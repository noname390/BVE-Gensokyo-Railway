...
Kyuto Main Line:<br>
#### Eientei->Chireiden
|#   |駅名          |優等列車停車駅|キロ |普通‐運行時間|深さ（幻想風穴駅=0）| 最高速度| 線路数| ホーム      |駅構造| 
|--- |---         |---       |--- |---         |---         |---    |---    |---         |---   |
| GO 03  |永遠亭   | 	○	  |     |           |            | 105		 |単線       |島式1面2線   |地面  | 
| C 04 |ひまわり畑 | 	↓	  |    | 	        |            | 		 |       　　　　|1面1線 | 地面 | 
| C 05 |幻想風穴   | 	↓	   |    |           |0            |95      |   |相対式1面2線   | 地面 |
| 06 |黒谷（信）   | 	↓	   |    |           |-203            |        |   |0面2線   | 洞窟内 |
| 07 |下人里（信） | 	↓	   |    |           |-1538            |        |   |0面2線   | 洞窟内（トンネル内） |
| 08 |うつほ定点   | 	↓	   |    |           |-3372            |        |   |0面1線   | 洞窟内 |
| 09 |上旧都定点   | 	↓	   |    |           |-3705            |        |   |0面1線   | 洞窟内 |
| C 09 |深道      | 	↓	   |    |           |-3908            |        |   |1面1線   | 洞窟内 |
| C 10 |水橋      | 	○	   |    |           |-3946            |        |   |相対式2面3線   | 地面(洞窟内) |
| C 11 |サトリ    | 	↓	   |    |           |-3944            |        |   |1面1線   | 地面(洞窟内) |
| C 12 |星熊温泉  | 	↓	   |    |           |-3972            |        |   |1面1線   | 地面(洞窟内) |
| C 13 |東旧都    | 	↓	   |    |           |-3980            |        |   |1面1線   | 地面(洞窟内) |
| C 14 |旧都      | 	○	   |    |           |-3974            |        |   |島式2面4線   | 地面(洞窟内) |
| C 15 |下旧都    | 	↓	   |    |           |-3991            |        |   |1面1線   | 地面(洞窟内) |
| C 16 |上古明地  | 	↓	   |    |           |-4001            |        |   |1面1線   | 地面(洞窟内) |
|C 17|地霊殿      | 	○	  |    |           |-4017             |		 |       |島式2面4線   | 地面(洞窟内) |
